    ...
    if(info) {
        ...
        //     enabled: true
            ...
            title: {
				...
				// console.log(data);
				if(data.length > 1000)
						data = Parse.decomposition(data, 900);
				chartOption.series = [{
						name: enNameToCnName(senseType),
						data: data
				}];
...
{
		if(o) {
				var renderTo = o.renderTo, 
				nodeId = o.nodeId || null, 
				sensorId = o.sensorId, 
				data = o.data, 
				senseType = codeToString(sensorId)[0],
				cnName = enNameToCnName(senseType), 
				chartOption = {},
				unit = "";
				...
				// $('#'+renderTo).highcharts(chartOption);
				// return chartOption;
		}
}
...
var charts = {
		drawToday: function(o) {
				// var startTime = newDataToString(new Date());
				// var startTime = "20130706";
